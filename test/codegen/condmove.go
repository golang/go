...
// or arg2 is zero.
func cmovzeroregZero11(a, b int) int {
	x := 0
	if a == b {
		x = a
	}
...
func cmoveAddZero11(cond, a, b int) int {
	if cond == 0 {
		a += b
	}
...
func cmoveAddNonZero11(cond, a, b int) int {
	if cond != 0 {
		a += b
	}
...
func cmoveSubZero11(cond, a, b int) int {
	if cond == 0 {
		a -= b
	}
...
func cmoveSubNonZero11(cond, a, b int) int {
	if cond != 0 {
		a -= b
	}
...
func cmoveOrZero11(cond, a, b int) int {
	if cond == 0 {
		a |= b
	}
...
func cmoveOrNonZero11(cond, a, b int) int {
	if cond != 0 {
		a |= b
	}
...
func cmoveXorZero11(cond, a, b int) int {
	if cond == 0 {
		a ^= b
	}
...
func cmoveXorNonZero11(cond, a, b int) int {
	if cond != 0 {
		a ^= b
	}
...
func cmoveAndZero11(cond, a, b int) int {
	if cond == 0 {
		a &= b
	}
...
func CondAndNonZero11(cond, a, b int) int {
	if cond != 0 {
		a &= b
	}
