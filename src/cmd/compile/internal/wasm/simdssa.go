...
func ssaGenSIMDValue(s *ssagen.State, v *ssa.Value, extend bool) bool {
	...
	case ssa.OpWasmI16x8Q15MulrSatS, ssa.OpWasmI16x8RelaxedQ15MulrS, ssa.OpWasmF32x4Pmax,
		...
		ssa.OpWasmI64x2LeS, ssa.OpWasmF64x2Le, ssa.OpWasmI8x16MaxS,
		ssa.OpWasmI8x16MaxU, ssa.OpWasmI16x8MaxS, ssa.OpWasmI16x8MaxU,
		ssa.OpWasmI32x4MaxS, ssa.OpWasmI32x4MaxU, ssa.OpWasmF32x4Max,
		ssa.OpWasmF64x2Max, ssa.OpWasmI8x16MinS, ssa.OpWasmI8x16MinU,
		ssa.OpWasmI16x8MinS, ssa.OpWasmI16x8MinU, ssa.OpWasmI32x4MinS,
		ssa.OpWasmI32x4MinU, ssa.OpWasmF32x4Min, ssa.OpWasmF64x2Min,
		ssa.OpWasmI16x8Mul, ssa.OpWasmI32x4Mul, ssa.OpWasmF32x4Mul,
		ssa.OpWasmI64x2Mul, ssa.OpWasmF64x2Mul, ssa.OpWasmI8x16Ne,
		ssa.OpWasmI16x8Ne, ssa.OpWasmI32x4Ne, ssa.OpWasmF32x4Ne,
		ssa.OpWasmI64x2Ne, ssa.OpWasmF64x2Ne, ssa.OpWasmV128Or,
		ssa.OpWasmI8x16Sub, ssa.OpWasmI16x8Sub, ssa.OpWasmI32x4Sub,
		ssa.OpWasmF32x4Sub, ssa.OpWasmI64x2Sub, ssa.OpWasmF64x2Sub,
		ssa.OpWasmI8x16SubSatS, ssa.OpWasmI8x16SubSatU, ssa.OpWasmI16x8SubSatS,
		ssa.OpWasmI16x8SubSatU, ssa.OpWasmV128Xor:
		getValue128(s, v.Args[0])
