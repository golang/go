...
func isIfBlock(b *ssa.Block) bool {
	...
	case blockpkg.BlockARM64Z,
		blockpkg.BlockARM64NZ,
		blockpkg.BlockARM64ZW,
		blockpkg.BlockARM64NZW:
		return true
	default:
		return false
	}
...
func condByBlockKind(kind blockpkg.BlockKind) ssaop.Op {
	switch kind {
	case blockpkg.BlockARM64EQ:
		return ssaop.OpARM64Equal
	case blockpkg.BlockARM64NE:
		return ssaop.OpARM64NotEqual
	case blockpkg.BlockARM64LT:
		return ssaop.OpARM64LessThan
	case blockpkg.BlockARM64LE:
		return ssaop.OpARM64LessEqual
	case blockpkg.BlockARM64GT:
		return ssaop.OpARM64GreaterThan
	case blockpkg.BlockARM64GE:
		return ssaop.OpARM64GreaterEqual
	case blockpkg.BlockARM64ULT:
		return ssaop.OpARM64LessThanU
	case blockpkg.BlockARM64ULE:
		return ssaop.OpARM64LessEqualU
	case blockpkg.BlockARM64UGT:
		return ssaop.OpARM64GreaterThanU
	case blockpkg.BlockARM64UGE:
...
func nzcvByBlockKind(kind blockpkg.BlockKind) uint8 {
	switch kind {
	case blockpkg.BlockARM64EQ:
		// Encode NE : Z == 0
...
func negateBlockKind(kind blockpkg.BlockKind) blockpkg.BlockKind {
	switch kind {
	case blockpkg.BlockARM64EQ:
		return blockpkg.BlockARM64NE
	case blockpkg.BlockARM64NE:
		return blockpkg.BlockARM64EQ
	case blockpkg.BlockARM64LT:
		return blockpkg.BlockARM64GE
	case blockpkg.BlockARM64LE:
		return blockpkg.BlockARM64GT
	case blockpkg.BlockARM64GT:
		return blockpkg.BlockARM64LE
	case blockpkg.BlockARM64GE:
		return blockpkg.BlockARM64LT
	case blockpkg.BlockARM64ULT:
		return blockpkg.BlockARM64UGE
	case blockpkg.BlockARM64ULE:
		return blockpkg.BlockARM64UGT
	case blockpkg.BlockARM64UGT:
		return blockpkg.BlockARM64ULE
	case blockpkg.BlockARM64UGE:
		return blockpkg.BlockARM64ULT
	default:
		panic("Incorrect kind of Block")
	}
}
...
func invertBlockKind(kind blockpkg.BlockKind) blockpkg.BlockKind {
	switch kind {
	case blockpkg.BlockARM64EQ:
		return blockpkg.BlockARM64EQ
	case blockpkg.BlockARM64NE:
