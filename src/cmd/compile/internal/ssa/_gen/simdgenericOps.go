...
func simdGenericOps() []opData {
	return []opData{
		...
		{name: "MulSignInt8x16", argLength: 2, commutative: false},
		{name: "MulSignInt8x32", argLength: 2, commutative: false},
		{name: "MulSignInt16x8", argLength: 2, commutative: false},
		{name: "MulSignInt16x16", argLength: 2, commutative: false},
		{name: "MulSignInt32x4", argLength: 2, commutative: false},
		{name: "MulSignInt32x8", argLength: 2, commutative: false},
