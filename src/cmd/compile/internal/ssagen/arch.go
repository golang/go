...
type ArchInfo struct {
	...
	SSAMarkMoves func(*State, *ssacore.Block)

	// SSAGenValue emits Prog(s) for the Value.
	SSAGenValue func(*State, *ssacore.Value)

	// SSAGenBlock emits end-of-block Progs. SSAGenValue should be called
	// for all values in the block before SSAGenBlock.
	SSAGenBlock func(s *State, b, next *ssacore.Block)
	...
	LoadRegResult func(s *State, f *ssacore.Func, t *types.Type, reg int16, n *ir.Name, off int64) *obj.Prog

	// SpillArgReg emits instructions that spill reg to n+off.
	SpillArgReg func(pp *objw.Progs, p *obj.Prog, f *ssacore.Func, t *types.Type, reg int16, n *ir.Name, off int64) *obj.Prog
