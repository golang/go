...
func simdARM64SVEIntrinsics(addF func(pkg, fn string, b intrinsicBuilder, archFamilies ...sys.ArchFamily)) {
	...
	addF(simdPackage, "Int8s.AndNot", opLen2(ssaop.OpAndNotInt8s, types.TypeVec256), sys.ARM64)
	addF(simdPackage, "Int16s.AndNot", opLen2(ssaop.OpAndNotInt16s, types.TypeVec256), sys.ARM64)
	addF(simdPackage, "Int32s.AndNot", opLen2(ssaop.OpAndNotInt32s, types.TypeVec256), sys.ARM64)
	addF(simdPackage, "Int64s.AndNot", opLen2(ssaop.OpAndNotInt64s, types.TypeVec256), sys.ARM64)
	addF(simdPackage, "Uint8s.AndNot", opLen2(ssaop.OpAndNotUint8s, types.TypeVec256), sys.ARM64)
	addF(simdPackage, "Uint16s.AndNot", opLen2(ssaop.OpAndNotUint16s, types.TypeVec256), sys.ARM64)
	addF(simdPackage, "Uint32s.AndNot", opLen2(ssaop.OpAndNotUint32s, types.TypeVec256), sys.ARM64)
	addF(simdPackage, "Uint64s.AndNot", opLen2(ssaop.OpAndNotUint64s, types.TypeVec256), sys.ARM64)
	...
	addF(simdPackage, "Float32s.Mul", opLen2(ssaop.OpMulFloat32s, types.TypeVec256), sys.ARM64)
	addF(simdPackage, "Float64s.Mul", opLen2(ssaop.OpMulFloat64s, types.TypeVec256), sys.ARM64)
	addF(simdPackage, "Int8s.Mul", opLen2(ssaop.OpMulInt8s, types.TypeVec256), sys.ARM64)
	addF(simdPackage, "Int16s.Mul", opLen2(ssaop.OpMulInt16s, types.TypeVec256), sys.ARM64)
	addF(simdPackage, "Int32s.Mul", opLen2(ssaop.OpMulInt32s, types.TypeVec256), sys.ARM64)
	addF(simdPackage, "Int64s.Mul", opLen2(ssaop.OpMulInt64s, types.TypeVec256), sys.ARM64)
	addF(simdPackage, "Uint8s.Mul", opLen2(ssaop.OpMulUint8s, types.TypeVec256), sys.ARM64)
	addF(simdPackage, "Uint16s.Mul", opLen2(ssaop.OpMulUint16s, types.TypeVec256), sys.ARM64)
	addF(simdPackage, "Uint32s.Mul", opLen2(ssaop.OpMulUint32s, types.TypeVec256), sys.ARM64)
	addF(simdPackage, "Uint64s.Mul", opLen2(ssaop.OpMulUint64s, types.TypeVec256), sys.ARM64)
	addF(simdPackage, "Int8s.MulHigh", opLen2(ssaop.OpMulHighInt8s, types.TypeVec256), sys.ARM64)
	addF(simdPackage, "Int16s.MulHigh", opLen2(ssaop.OpMulHighInt16s, types.TypeVec256), sys.ARM64)
	addF(simdPackage, "Int32s.MulHigh", opLen2(ssaop.OpMulHighInt32s, types.TypeVec256), sys.ARM64)
	addF(simdPackage, "Int64s.MulHigh", opLen2(ssaop.OpMulHighInt64s, types.TypeVec256), sys.ARM64)
	addF(simdPackage, "Uint8s.MulHigh", opLen2(ssaop.OpMulHighUint8s, types.TypeVec256), sys.ARM64)
	addF(simdPackage, "Uint16s.MulHigh", opLen2(ssaop.OpMulHighUint16s, types.TypeVec256), sys.ARM64)
	addF(simdPackage, "Uint32s.MulHigh", opLen2(ssaop.OpMulHighUint32s, types.TypeVec256), sys.ARM64)
	addF(simdPackage, "Uint64s.MulHigh", opLen2(ssaop.OpMulHighUint64s, types.TypeVec256), sys.ARM64)
	...
	addF(simdPackage, "Int8s.Or", opLen2(ssaop.OpOrInt8s, types.TypeVec256), sys.ARM64)
	addF(simdPackage, "Int16s.Or", opLen2(ssaop.OpOrInt16s, types.TypeVec256), sys.ARM64)
	addF(simdPackage, "Int32s.Or", opLen2(ssaop.OpOrInt32s, types.TypeVec256), sys.ARM64)
	addF(simdPackage, "Int64s.Or", opLen2(ssaop.OpOrInt64s, types.TypeVec256), sys.ARM64)
	addF(simdPackage, "Uint8s.Or", opLen2(ssaop.OpOrUint8s, types.TypeVec256), sys.ARM64)
	addF(simdPackage, "Uint16s.Or", opLen2(ssaop.OpOrUint16s, types.TypeVec256), sys.ARM64)
	addF(simdPackage, "Uint32s.Or", opLen2(ssaop.OpOrUint32s, types.TypeVec256), sys.ARM64)
	addF(simdPackage, "Uint64s.Or", opLen2(ssaop.OpOrUint64s, types.TypeVec256), sys.ARM64)
	...
	addF(simdPackage, "Int8s.Xor", opLen2(ssaop.OpXorInt8s, types.TypeVec256), sys.ARM64)
	addF(simdPackage, "Int16s.Xor", opLen2(ssaop.OpXorInt16s, types.TypeVec256), sys.ARM64)
	addF(simdPackage, "Int32s.Xor", opLen2(ssaop.OpXorInt32s, types.TypeVec256), sys.ARM64)
	addF(simdPackage, "Int64s.Xor", opLen2(ssaop.OpXorInt64s, types.TypeVec256), sys.ARM64)
	addF(simdPackage, "Uint8s.Xor", opLen2(ssaop.OpXorUint8s, types.TypeVec256), sys.ARM64)
	addF(simdPackage, "Uint16s.Xor", opLen2(ssaop.OpXorUint16s, types.TypeVec256), sys.ARM64)
	addF(simdPackage, "Uint32s.Xor", opLen2(ssaop.OpXorUint32s, types.TypeVec256), sys.ARM64)
	addF(simdPackage, "Uint64s.Xor", opLen2(ssaop.OpXorUint64s, types.TypeVec256), sys.ARM64)
