...
func simdARM64Intrinsics(addF func(pkg, fn string, b intrinsicBuilder, archFamilies ...sys.ArchFamily)) {
	...
	addF(simdPackage, "Int8x16.ConcatAddPairs", opLen2(ssa.OpConcatAddPairsInt8x16, types.TypeVec128), sys.ARM64)
	...
	addF(simdPackage, "Uint8x16.ConcatAddPairs", opLen2(ssa.OpConcatAddPairsUint8x16, types.TypeVec128), sys.ARM64)
