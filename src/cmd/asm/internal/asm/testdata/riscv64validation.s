...
TEXT validation(SB),$0
	...
	VWSLLVI $32, V2, V4			// ERROR "signed immediate 32 must be in range [0, 31]"
	VWSLLVI $-1, V2, V4			// ERROR "signed immediate -1 must be in range [0, 31]"
	VRORVI $32, V2, V4			// ERROR "signed immediate 32 must be in range [0, 31]"
	VRORVI $-1, V2, V4			// ERROR "signed immediate -1 must be in range [0, 31]"
