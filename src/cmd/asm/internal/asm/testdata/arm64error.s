...
TEXT errors(SB),$0
	...
	CASPALD	(R3, R4), (R2), (R8, R9)                         // ERROR "source register pair must start from even register"
	CASPALD	(R2, R3), (R2), (R9, R10)                        // ERROR "destination register pair must start from even register"
