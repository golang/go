...
TEXT errors(SB),$0
	...
	CJ	X5, 2(PC)			// ERROR "too many operands for instruction"
	JAL	X5, X6, 2(PC)			// ERROR "too many operands for instruction"
	JMP	X5, 2(PC)			// ERROR "too many operands for instruction"
	...
	VAESDFVS	V2, V4, V3			// ERROR "too many operands for instruction"
	VAESDFVV	V2, V4, V3			// ERROR "too many operands for instruction"
	VAESDMVS	V2, V4, V3			// ERROR "too many operands for instruction"
	VAESDMVV	V2, V4, V3			// ERROR "too many operands for instruction"
	VAESEFVS	V2, V4, V3			// ERROR "too many operands for instruction"
	VAESEFVV	V2, V4, V3			// ERROR "too many operands for instruction"
	VAESEMVS	V2, V4, V3			// ERROR "too many operands for instruction"
	VAESEMVV	V2, V4, V3			// ERROR "too many operands for instruction"
	VAESKF1VI	$0, V2, V4, V3			// ERROR "too many operands for instruction"
	VAESKF2VI	$0, V2, V4, V3			// ERROR "too many operands for instruction"
	VAESZVS		V2, V4, V3			// ERROR "too many operands for instruction"
	VGHSHVV		V1, V2, V4, V3			// ERROR "too many operands for instruction"
	VGMULVV		V2, V4, V3			// ERROR "too many operands for instruction"
	VSHA2CHVV	V1, V2, V4, V3			// ERROR "too many operands for instruction"
	VSHA2CLVV	V1, V2, V4, V3			// ERROR "too many operands for instruction"
	VSHA2MSVV	V1, V2, V4, V3			// ERROR "too many operands for instruction"
	VSM3CVI		$0, V2, V4, V3			// ERROR "too many operands for instruction"
	VSM3MEVV	V1, V2, V4, V3			// ERROR "too many operands for instruction"
	VSM4KVI		$0, V2, V4, V3			// ERROR "too many operands for instruction"
