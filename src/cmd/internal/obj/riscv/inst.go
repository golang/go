...
func encode(a obj.As) *inst {
	...
	case ABCLR:
		return &inst{0x33, 0x1, 0, 0, 0x24}
	case ABEXT:
		return &inst{0x33, 0x5, 0, 0, 0x24}
	case ABINV:
		return &inst{0x33, 0x1, 0, 0, 0x34}
	case ABSET:
		return &inst{0x33, 0x1, 0, 0, 0x14}
	case ABCLRI:
		return &inst{0x13, 0x1, 0, 0x480, 0x24}
	case ABEXTI:
		return &inst{0x13, 0x5, 0, 0x480, 0x24}
	case ABINVI:
		return &inst{0x13, 0x1, 0, 0x680, 0x34}
	case ABSETI:
		return &inst{0x13, 0x1, 0, 0x280, 0x14}
	}
	return nil
}
