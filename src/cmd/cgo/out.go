...
func (p *Package) writeDefs() {
	...
	fmt.Fprint(fm, "#include <stddef.h>\n") // For size_t below.
	fmt.Fprint(fm, "int main() { return 0; }\n")
	if *importRuntimeCgo {
		fmt.Fprint(fm, "void crosscall2(void(*fn)(void*) __attribute__((unused)), void *a __attribute__((unused)), int c __attribute__((unused)), size_t ctxt __attribute__((unused))) { }\n")
		fmt.Fprint(fm, "size_t _cgo_wait_runtime_init_done(void) { return 0; }\n")
		fmt.Fprint(fm, "void _cgo_release_context(size_t ctxt __attribute__((unused))) { }\n")
		fmt.Fprint(fm, "char* _cgo_topofstack(void) { return (char*)0; }\n")
	} else {
		// If we're not importing runtime/cgo, we *are* runtime/cgo,
		// which provides these functions. We just need a prototype.
		fmt.Fprint(fm, "void crosscall2(void(*fn)(void*), void *a, int c, size_t ctxt);\n")
		fmt.Fprint(fm, "size_t _cgo_wait_runtime_init_done(void);\n")
		fmt.Fprint(fm, "void _cgo_release_context(size_t);\n")
	}
	fmt.Fprint(fm, "void _cgo_allocate(void *a __attribute__((unused)), int c __attribute__((unused))) { }\n")
	fmt.Fprint(fm, "void _cgo_panic(void *a __attribute__((unused)), int c __attribute__((unused))) { }\n")
	fmt.Fprint(fm, "void _cgo_reginit(void) { }\n")

	// Write second Go output: definitions of _C_xxx.
	// In a separate file so that the import of "unsafe" does not
	// pollute the original file.
	fmt.Fprint(fgo2, "// Code generated by cmd/cgo; DO NOT EDIT.\n\n")
	fmt.Fprintf(fgo2, "package %s\n\n", p.PackageName)
	fmt.Fprint(fgo2, "import \"unsafe\"\n\n")
	if *importSyscall {
		fmt.Fprint(fgo2, "import \"syscall\"\n\n")
	}
	if *importRuntimeCgo {
		if !*gccgoDefineCgoIncomplete {
			fmt.Fprint(fgo2, "import _cgopackage \"runtime/cgo\"\n\n")
			fmt.Fprint(fgo2, "type _ _cgopackage.Incomplete\n") // prevent import-not-used error
		} else {
			fmt.Fprint(fgo2, "//go:notinheap\n")
			fmt.Fprint(fgo2, "type _cgopackage_Incomplete struct{ _ struct{ _ struct{} } }\n")
		}
	}
	if *importSyscall {
		fmt.Fprint(fgo2, "var _ syscall.Errno\n")
	}
	fmt.Fprint(fgo2, "func _Cgo_ptr(ptr unsafe.Pointer) unsafe.Pointer { return ptr }\n\n")

	if !*gccgo {
		fmt.Fprint(fgo2, "//go:linkname _Cgo_always_false runtime.cgoAlwaysFalse\n")
		fmt.Fprint(fgo2, "var _Cgo_always_false bool\n")
		fmt.Fprint(fgo2, "//go:linkname _Cgo_use runtime.cgoUse\n")
		fmt.Fprint(fgo2, "func _Cgo_use(interface{})\n")
	}
	...
	if *gccgo {
		fmt.Fprint(fgo2, "type _Ctype_void byte\n")
	} else {
		fmt.Fprint(fgo2, "type _Ctype_void [0]byte\n")
	}
	...
	if fc != nil {
		fmt.Fprint(fc, "#line 1 \"cgo-generated-wrappers\"\n")
	}
	if fm != nil {
		fmt.Fprint(fm, "#line 1 \"cgo-generated-wrappers\"\n")
	}
...
func (p *Package) writeDefsFunc(fgo2 io.Writer, n *Name, callsMalloc *bool) {
	...
	if n.AddError {
		fmt.Fprint(fgo2, "\tif errno != 0 { r2 = syscall.Errno(errno) }\n")
	}
	fmt.Fprint(fgo2, "\tif _Cgo_always_false {\n")
	if d.Type.Params != nil {
...
func (p *Package) writeOutput(f *File, srcfile string) {
	...
	fmt.Fprint(fgo1, "// Code generated by cmd/cgo; DO NOT EDIT.\n\n")
...
func (p *Package) writeOutputFunc(fgcc *os.File, n *Name) {
	...
	fmt.Fprint(fgcc, "CGO_NO_SANITIZE_THREAD\n")
	if n.AddError {
		fmt.Fprint(fgcc, "int\n")
	} else {
		fmt.Fprint(fgcc, "void\n")
	}
	fmt.Fprintf(fgcc, "_cgo%s%s(void *v)\n", cPrefix, n.Mangle)
	fmt.Fprint(fgcc, "{\n")
	if n.AddError {
		fmt.Fprint(fgcc, "\tint _cgo_errno;\n")
	}
	...
	if n.FuncType.Result != nil {
		...
		fmt.Fprint(fgcc, "\tchar *_cgo_stktop = _cgo_topofstack();\n")
	}
	tr := n.FuncType.Result
	if tr != nil {
		fmt.Fprint(fgcc, "\t__typeof__(_cgo_a->r) _cgo_r;\n")
	}
	fmt.Fprint(fgcc, "\t_cgo_tsan_acquire();\n")
	if n.AddError {
		fmt.Fprint(fgcc, "\terrno = 0;\n")
	}
	fmt.Fprint(fgcc, "\t")
	if tr != nil {
		fmt.Fprint(fgcc, "_cgo_r = ")
	...
	if n.AddError {
		fmt.Fprint(fgcc, "\t_cgo_errno = errno;\n")
	}
	fmt.Fprint(fgcc, "\t_cgo_tsan_release();\n")
	if n.FuncType.Result != nil {
		// The cgo call may have caused a stack copy (via a callback).
		// Adjust the return value pointer appropriately.
		fmt.Fprint(fgcc, "\t_cgo_a = (void*)((char*)_cgo_a + (_cgo_topofstack() - _cgo_stktop));\n")
		// Save the return value.
		fmt.Fprint(fgcc, "\t_cgo_a->r = _cgo_r;\n")
		...
		// See issue 26209.
		fmt.Fprint(fgcc, "\t_cgo_msan_write(&_cgo_a->r, sizeof(_cgo_a->r));\n")
	}
	if n.AddError {
		fmt.Fprint(fgcc, "\treturn _cgo_errno;\n")
	}
	fmt.Fprint(fgcc, "}\n")
	fmt.Fprint(fgcc, "\n")
}
...
func (p *Package) writeExports(fgo2, fm, fgcc, fgcch io.Writer) {
	...
	fmt.Fprint(fgcc, "/* Code generated by cmd/cgo; DO NOT EDIT. */\n\n")
	fmt.Fprint(fgcc, "#include <stdlib.h>\n")
	fmt.Fprint(fgcc, "#include \"_cgo_export.h\"\n\n")
	...
	fmt.Fprint(fgcc, "#pragma GCC diagnostic ignored \"-Wunknown-pragmas\"\n")
	fmt.Fprint(fgcc, "#pragma GCC diagnostic ignored \"-Wpragmas\"\n")
	fmt.Fprint(fgcc, "#pragma GCC diagnostic ignored \"-Waddress-of-packed-member\"\n")

	fmt.Fprint(fgcc, "extern void crosscall2(void (*fn)(void *), void *, int, size_t);\n")
	fmt.Fprint(fgcc, "extern size_t _cgo_wait_runtime_init_done(void);\n")
	fmt.Fprint(fgcc, "extern void _cgo_release_context(size_t);\n\n")
	fmt.Fprint(fgcc, "extern char* _cgo_topofstack(void);")
	fmt.Fprintf(fgcc, "%s\n", tsanProlog)
	fmt.Fprintf(fgcc, "%s\n", msanProlog)
	...
	for _, exp := range p.ExpFunc {
		...
		fmt.Fprintf(fgcc, "\n%s\n", s)
		fmt.Fprint(fgcc, "{\n")
		fmt.Fprint(fgcc, "\tsize_t _cgo_ctxt = _cgo_wait_runtime_init_done();\n")
		...
		fmt.Fprint(fgcc, "\tstatic _cgo_argtype _cgo_zero;\n")
		fmt.Fprint(fgcc, "\t_cgo_argtype _cgo_a = _cgo_zero;\n")
		if gccResult != "void" && (len(fntype.Results.List) > 1 || len(fntype.Results.List[0].Names) > 1) {
			fmt.Fprintf(fgcc, "\t%s r;\n", gccResult)
		}
		if fn.Recv != nil {
			fmt.Fprint(fgcc, "\t_cgo_a.recv = recv;\n")
		}
		forFieldList(fntype.Params,
			func(i int, aname string, atype ast.Expr) {
		...
		fmt.Fprint(fgcc, "\t_cgo_tsan_acquire();\n")
		fmt.Fprint(fgcc, "\t_cgo_release_context(_cgo_ctxt);\n")
		if gccResult != "void" {
			if len(fntype.Results.List) == 1 && len(fntype.Results.List[0].Names) <= 1 {
				fmt.Fprint(fgcc, "\treturn _cgo_a.r0;\n")
			} else {
				forFieldList(fntype.Results,
					func(i int, aname string, atype ast.Expr) {
...
func (p *Package) writeGccgoExports(fgo2, fm, fgcc, fgcch io.Writer) {
	...
	for _, exp := range p.ExpFunc {
		...
		fmt.Fprint(fgcc, "\tif(_cgo_wait_runtime_init_done)\n")
		fmt.Fprint(fgcc, "\t\t_cgo_wait_runtime_init_done();\n")
		fmt.Fprint(fgcc, "\t_cgo_tsan_release();\n")
		fmt.Fprint(fgcc, "\t")
		if resultCount > 0 {
			fmt.Fprint(fgcc, "r = ")
...
func (p *Package) writeExportHeader(fgcch io.Writer) {
	fmt.Fprint(fgcch, "/* Code generated by cmd/cgo; DO NOT EDIT. */\n\n")
	pkg := *importPath
	if pkg == "" {
		pkg = p.PackagePath
	}
	...
	fmt.Fprint(fgcch, "/* Start of preamble from import \"C\" comments.  */\n\n")
	fmt.Fprintf(fgcch, "%s\n", preamble)
