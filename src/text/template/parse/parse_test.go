...
var errorTests = []parseTest{
	...
	{"unclosed1",
		"line1\n{{",
		hasError, `unclosed1:2:2 unclosed action`},
	{"unclosed2",
		"line1\n{{define `x`}}line2\n{{",
		hasError, `unclosed2:3:2 unclosed action`},
	{"unclosed3",
		"line1\n{{\"x\"\n\"y\"\n",
		hasError, `unclosed3:4:0 unclosed action started at unclosed3:2`},
	{"unclosed4",
		"{{\n\n\n\n\n",
		hasError, `unclosed4:6:0 unclosed action started at unclosed4:1`},
	{"var1",
		"line1\n{{\nx\n}}",
		hasError, `var1:3:0 function "x" not defined`},
	// Specific errors.
	{"function",
		"{{foo}}",
	...
	{"comment1",
		"{{/*}}",
		hasError, `comment1:1:2 unclosed comment`},
	{"comment2",
		"{{/*\nhello\n}}",
		hasError, `comment2:1:2 unclosed comment`},
	{"lparen",
		"{{.X (1 2 3}}",
	...
	{"multilinerawstring",
		"{{ $v := `\n` }} {{",
		hasError, `multilinerawstring:2:7 unclosed action`},
	{"rangeundefvar",
		"{{range $k}}{{end}}",
		hasError, `undefined variable`},
	{"rangeundefvars",
