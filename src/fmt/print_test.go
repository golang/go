...
func Test_intFromArg(t *testing.T) {
	...
	var tests = []struct {
		...
		{"int", args{[]any{0}, 0}, want{0, true, 1}},
		{"myint", args{[]any{myint(1)}, 0}, want{1, true, 1}},
		...
		{"uint8", args{[]any{uint8(6)}, 0}, want{6, true, 1}},
		{"uint16", args{[]any{uint16(7)}, 0}, want{7, true, 1}},
		{"uint32", args{[]any{uint32(8)}, 0}, want{8, true, 1}},
		{"uint64", args{[]any{uint64(9)}, 0}, want{9, true, 1}},

		{"toolarge", args{[]any{1e6 + 10}, 0}, want{0, false, 1}},
		{"float", args{[]any{11.0}, 0}, want{0, false, 1}},
		{"struct", args{[]any{struct{ int }{12}}, 0}, want{0, false, 1}},
