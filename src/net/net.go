...
On Windows, the resolver uses C library functions, such as
GetAddrInfo and DnsQuery, by default. This can be overridden with
GODEBUG=netdns=go to force the pure Go resolver.
*/
package net
