...
On Windows, the resolver uses Go's built-in resolver by default,
which performs DNS lookups directly rather than calling C library functions.
This can be controlled via the GODEBUG environment variable.
*/
package net
