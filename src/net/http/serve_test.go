...
func BenchmarkClient(b *testing.B) {
	...
	url := startClientBenchmarkServer(b, "BenchmarkClient", func(w ResponseWriter, _ *Request) {
...
func startClientBenchmarkServer(b *testing.B, benchmarkName string, handler func(ResponseWriter, *Request)) string {
	b.ReportAllocs()
	b.StopTimer()
...
func BenchmarkClientGzip(b *testing.B) {
	...
	url := startClientBenchmarkServer(b, "BenchmarkClientGzip", func(w ResponseWriter, _ *Request) {
