...
// MethodNotAllowed function defines the default 405 processing and
// returns Allow and X-Match-Route Header.
func MethodNotAllowed(w ResponseWriter, r *Request) {
	w.Header().Set("Allow", r.GetPathValue("allow"))
	Error(w, "405 method not allowed", StatusMethodNotAllowed)
}
