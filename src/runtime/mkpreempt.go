...
func header(arch string) {
	fmt.Fprint(out, "// Code generated by mkpreempt.go; DO NOT EDIT.\n\n")
	if beLe[arch] {
		base := arch[:len(arch)-1]
		fmt.Fprintf(out, "//go:build %s || %sle\n\n", base, base)
	}
	fmt.Fprint(out, "#include \"go_asm.h\"\n")
	if arch == "amd64" {
		fmt.Fprint(out, "#include \"asm_amd64.h\"\n")
	}
	fmt.Fprint(out, "#include \"textflag.h\"\n\n")
	fmt.Fprint(out, "TEXT ·asyncPreempt(SB),NOSPLIT|NOFRAME,$0-0\n")
}
