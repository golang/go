...
func GetCommandLine() (cmd *uint16) {
	r0, _, _ := SyscallN(procGetCommandLineW.Addr(), 0)
...
func GetCurrentProcess() (pseudoHandle Handle, err error) {
	r0, _, e1 := SyscallN(procGetCurrentProcess.Addr(), 0)
...
func getCurrentProcessId() (pid uint32) {
	r0, _, _ := SyscallN(procGetCurrentProcessId.Addr(), 0)
	pid = uint32(r0)
	return
}

func GetEnvironmentStrings() (envs *uint16, err error) {
	r0, _, e1 := SyscallN(procGetEnvironmentStringsW.Addr(), 0)
...
func GetLastError() (lasterr error) {
	r0, _, _ := SyscallN(procGetLastError.Addr(), 0)
	if r0 != 0 {
		lasterr = Errno(r0)
	}
	return
...
func GetStartupInfo(startupInfo *StartupInfo) (err error) {
	r1, _, e1 := SyscallN(procGetStartupInfoW.Addr(), uintptr(unsafe.Pointer(startupInfo)))
	if r1 == 0 {
		err = errnoErr(e1)
	}
	return
...
func GetVersion() (ver uint32, err error) {
	r0, _, e1 := SyscallN(procGetVersion.Addr(), 0)
	ver = uint32(r0)
	if ver == 0 {
		err = errnoErr(e1)
	}
...
func WSACleanup() (err error) {
	r1, _, e1 := SyscallN(procWSACleanup.Addr(), 0)
	if r1 == socket_error {
		err = errnoErr(e1)
	}
	return
