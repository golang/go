...
func blockGeneric(dig *digest, p []byte) {
	...
	for i := 0; i <= len(p)-BlockSize; i += BlockSize {
		...
		// load input block
		x0 := binarylite.LittleEndian.Uint32(q[4*0x0:])
		x1 := binarylite.LittleEndian.Uint32(q[4*0x1:])
		x2 := binarylite.LittleEndian.Uint32(q[4*0x2:])
		x3 := binarylite.LittleEndian.Uint32(q[4*0x3:])
		x4 := binarylite.LittleEndian.Uint32(q[4*0x4:])
		x5 := binarylite.LittleEndian.Uint32(q[4*0x5:])
		x6 := binarylite.LittleEndian.Uint32(q[4*0x6:])
		x7 := binarylite.LittleEndian.Uint32(q[4*0x7:])
		x8 := binarylite.LittleEndian.Uint32(q[4*0x8:])
		x9 := binarylite.LittleEndian.Uint32(q[4*0x9:])
		xa := binarylite.LittleEndian.Uint32(q[4*0xa:])
		xb := binarylite.LittleEndian.Uint32(q[4*0xb:])
		xc := binarylite.LittleEndian.Uint32(q[4*0xc:])
		xd := binarylite.LittleEndian.Uint32(q[4*0xd:])
		xe := binarylite.LittleEndian.Uint32(q[4*0xe:])
		xf := binarylite.LittleEndian.Uint32(q[4*0xf:])
